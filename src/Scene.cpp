...
void Scene::imageCarre()
{
	...
	for (int i = 0 ; i< 11 ; i++)
	{
		m_objectsList.push_back(Sphere(PVect(-1.0+(float(i)/5.0),6.0,1.0), 0.1,new Lambert(PVect(0.0,0.0,255.0))));
		m_objectsList.push_back(Sphere(PVect(-1.0,6.0,1.0-(float(i)/5.0)), 0.1,new Lambert(PVect(0.0,0.0,255.0))));

		m_objectsList.push_back(Sphere(PVect(1.0,6.0,-1.0+(float(i)/5.0)), 0.1,new Phong(PVect(0.0,0.0,125.0),PVect(0.0,0.0,125.0),8)));
		m_objectsList.push_back(Sphere(PVect(1.0-(float(i)/5.0),6.0,-1.0), 0.1,new Phong(PVect(0.0,0.0,125.0),PVect(0.0,0.0,125.0),8)));
...
{
	m_source.push_back(Source(PVect(5.0,0.0,0.0),PVect(1.0,1.0,1.0)));
	m_objectsList.push_back(Sphere(PVect(0.0,3.0,0.0), 0.5,new Phong(PVect(125.0,125.0,0.0),PVect(125.0,125.0,0.0),8)));
